...
const AddNewOutlet = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://eggbucket-b2b-website-deploy.onrender.com/egg-bucket-b2b/get-all-outlets')
      .then((response) => response.json())
      .then((data) => {
        if (data.status === 'success') {
          const latestOutletNumber =
            data.data.slice(-1)[0]?.outletNumber || '0';
    ...
    fetch(
      'https://eggbucket-b2b-website-deploy.onrender.com/outletPartners/egg-bucket-b2b/displayAll-outlet_partner'
    )
      .then((response) => response.json())
      .then((data) => {
        if (data.status === 'success') {
    ...
    fetch(
      'https://eggbucket-b2b-website-deploy.onrender.com/deliveryDrivers/egg-bucket-b2b/displayAll-delivery_partner'
    )
      .then((response) => response.json())
      .then((data) => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch('https://eggbucket-b2b-website-deploy.onrender.com/egg-bucket-b2b/create-outlet', {
      method: 'POST',
      body: formDataToSend,
    })
      .then((response) => response.json())
