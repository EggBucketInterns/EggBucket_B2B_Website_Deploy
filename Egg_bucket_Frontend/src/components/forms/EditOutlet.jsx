...
const EditOutlet = ({ outlet, onClose, onSave }) => {
  ...
  useEffect(() => {
    const fetchOutletPartners = async () => {
      try {
        const response = await fetch('https://eggbucket-b2b-website-deploy.onrender.com/outletPartners/egg-bucket-b2b/displayAll-outlet_partner');
    ...
    const fetchDeliveryPartners = async () => {
      try {
        const response = await fetch('https://eggbucket-b2b-website-deploy.onrender.com/deliveryDrivers/egg-bucket-b2b/displayAll-delivery_partner');
