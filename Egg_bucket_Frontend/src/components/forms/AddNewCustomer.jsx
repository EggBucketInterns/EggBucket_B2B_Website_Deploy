...
const AddNewCustomer = () => {
  ...
  useEffect(() => {
    ...
    // Fetch all customers
    fetch('https://eggbucket-b2b-website-deploy.onrender.com/customers/egg-bucket-b2b/getAllCustomer')
      .then(response => response.json())
      .then(data => {
        if (data.length > 0) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Submit form data
      const response = await fetch('https://eggbucket-b2b-website-deploy.onrender.com/customers/egg-bucket-b2b/create-customer', {
        method: 'POST',
        body: formDataToSend,
      });
