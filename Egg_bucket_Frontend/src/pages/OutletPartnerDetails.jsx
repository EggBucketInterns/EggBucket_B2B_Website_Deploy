...
const OutletPartnerDetails = () => {
  ...
  const fetchOutlets = async () => {
    try {
      const response = await axios.get('https://eggbucket-b2b-website-deploy.onrender.com/egg-bucket-b2b/get-all-outlets');
  ...
  const fetchOutletPartners = async (query = '') => {
    try {
      const response = await axios.get('https://eggbucket-b2b-website-deploy.onrender.com/outletPartners/egg-bucket-b2b/displayAll-outlet_partner' + query);
  ...
  const handleSaveEdit = async (formData) => {
    try {
      const response = await axios.patch(`https://eggbucket-b2b-website-deploy.onrender.com/outletPartners/egg-bucket-b2b/outlet_partner/${editingOutletPartner._id}`, formData);
  ...
  const handleDeleteClick = async (partnerId) => {
    ...
    if (confirmDelete) {
      try {
        const response = await axios.delete(`https://eggbucket-b2b-website-deploy.onrender.com/outletPartners/egg-bucket-b2b/outlet_partner/${partnerId}`);
        if (response.status === 200) {
